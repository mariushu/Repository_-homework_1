...
public class JamesHelper {
  ...
  public JamesHelper(ApplicationMenager app) {
    this.app = app;
  ...
  public void createUser(String name, String passwd) {
    ...
    String result = readUntil("User " + name + " added"); //wait while text is appeared on consol
    closeTelnetSession();
  }
  ...
  public void drainEmail(String username, String password) throws MessagingException { //deletion of all emails which some user received
  ...
  private void closeFolder(Folder folder) throws MessagingException {
    folder.close(true); //true means deletion of all mails marked as deleting
    store.close(); //connection to mail server closed
  }
